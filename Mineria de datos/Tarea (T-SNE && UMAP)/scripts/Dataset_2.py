...
COLUMNAS_EXCLUIR = ['calidad']
COLORES = plt.cm.tab10.colors


def preparar_datos(df, target_col='calidad'):
...
def acp(df, target_col='calidad', n_components=3, random_state=42, graficar=True):
...
def tsne(df, target_col='calidad', n_components=3, perplexity=30, random_state=42, graficar=True):
    X_scaled, y = preparar_datos(df, target_col)
...
def umap(df, target_col='calidad', n_components=3, lista_vecinos=None, random_state=42, graficar=True):
...
def graficar_comparacion_2d(resultado_acp, resultado_tsne, resultado_umap, target_col='calidad'):
...
def graficar_comparacion_3d(resultado_acp, resultado_tsne, resultado_umap, target_col='calidad'):
